...
NUM_EPOCHS = 3
VALID_SPLIT = 0.2
MAX_LEN = 25 # EDA에서 추출된 Max Length
...
filename1='/content/drive/MyDrive/리뽀/data/train_Mecab(all_alphabet).csv'
filename2='/content/drive/MyDrive/리뽀/data/news_test_preprocessing_Mecab(all_alphabet)_12.21.csv'
filename3='drive/My Drive/sample_submission.csv'
...
for train_sent, train_label in tqdm(zip(train_data["new_article"], train_data["info"]), total=len(train_data)):
    try:
